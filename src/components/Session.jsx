...
const Session = ({
  ...
  return (
    <div className="session">
      ...
      <p className="sessiontime" id="session-length" >{sessionLengthInMinutes}</p>
      </div>
     ...
     <button className="btnController" id="session-increment" onClick={incrementSessionLengthByOneMinute}>
        +
      </button>
      <button className="btnController" id="session-decrement" onClick={decrementSessionLengthByOneMinute}>
        -
      </button>
     </div>
